            ...
            <main className="container lg:px-40 mb-10">
                <div id="appContent" className="px-4 pt-4">
                    ...
                    <div className="flex justify-between mt-6 gap-2">
                        ...
                        <Link href={"/history"} className="bg-indigo-600 text-white rounded-lg px-4 py-2 text-sm flex items-center space-x-2 hover:bg-indigo-700 transition-colors flex-1 justify-center">
